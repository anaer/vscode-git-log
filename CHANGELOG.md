...
- Reworked the Changed Files tree with the same native TreeView styling: SVG chevron collapse/expand, vertical indentation guide lines, and a wider per-level indent.
